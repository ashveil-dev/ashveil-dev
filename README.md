<img src="https://capsule-render.vercel.app/api?type=waving&height=300&section=header&text=ashveil&fontSize=70&fontAlign=80&fontAlignY=40&color=gradient&customColorList=1,2" />
...
![General badge](https://img.shields.io/badge/-ReactJs-61DAFB?logo=react&logoColor=white&style=for-the-badge) 
...
![General badge](https://img.shields.io/badge/Tailwind_CSS-grey?style=for-the-badge&logo=tailwind-css&logoColor=white)
</div>
...
🤔 Visual Studio Code를 이용하여 개발하며, Chrome을 이용하여 주로 개발을 진행합니다  
📜 꿈은 크게 가지는 편이라, 국제 해킹 대회에서 수상하는 것을 목표로 하고 있습니다  
💣 TMI - 피아노 악보를 보면서 치거나 혼자 코인노래방을 가는 것을 좋아하며 집 꾸미기를 자주 합니다  
📫 이메일 - ashveil.dev@gmail.com  
🎮 블로그 - <a href="http://ashveil.tistory.com">LogSomething</a> 
